...
const History = () => {
  ...
  useEffect(() => {
    // Load history from localStorage or any other storage
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <Card className="max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <CardHeader className="flex flex-row items-start justify-between">
                <div>
                  <CardTitle className="text-xl">{selectedAnalysis.prediction}</CardTitle>
                  <CardDescription>
                    {selectedAnalysis.date} at {selectedAnalysis.time}
                  </CardDescription>
                </div>
                <Button
                  variant="ghost"
